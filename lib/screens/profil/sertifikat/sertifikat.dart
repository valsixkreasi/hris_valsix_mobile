    ...
    return RefreshIndicator(
      ...
      child: NavHeader(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.pushNamed(context, '/sertifikat_add');
            },
                    ...
                    ? Column(
                        children: [
                          ...List.generate(data.length, (index) {
                            ...
                            return Button(
                              onPressed: () {
                                if (dataItem['pengajuan_sertifikat_id'] !=
                                    null) {
                                } else {
                                  // Navigator.pushNamed(
                                  //   context,
                                  //   '/sertifikat_view',
                                  //   arguments: {
                                  //     'id': dataItem['pengajuan_sertifikat_id'],
                                  //   },
                                  // );
                                }
                              },
                              ...
                              child: Card(
                                ...
                                color:
                                    dataItem['pengajuan_sertifikat_id'] != null
                                        ? Color(0xfffee86d)
                                        : Color(0xfff2f2f2),
                                child: Column(
                                  children: [
