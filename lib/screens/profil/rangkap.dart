...
class Rangkap extends StatefulWidget {
  const Rangkap({super.key});

  @override
  State<Rangkap> createState() => _RangkapState();
}

class _RangkapState extends State<Rangkap> {
  ...
  void getData() {
    _getData().then((value) {
      ...
      if (value != null) {
        ...
        List<Map<String, dynamic>> arrData = List.from(profil['rangkap']);
