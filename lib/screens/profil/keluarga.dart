  ...
  void getData() {
    _getData().then((value) {
      ...
      if (value != null) {
        ...
        List<Map<String, dynamic>> arrData = List.from(profil['keluarga']);
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        InputView(
                                            ...
                                            value:
                                                '${dataItem['tempat_lahir'] ?? '-'}, ${dataItem['tanggal_lahir']}'),
                                        InputView(
                                            label: 'No. KTP :',
                                            value: dataItem['no_ktp'] ?? '-'),
                                        InputView(
                                            label: 'No. BPJS :',
                                            value: dataItem['bpjs_kesehatan'] ??
                                                '-'),
                                        InputView(
                                            label: 'Tanggungan Kesehatan :',
                                            value: dataItem[
