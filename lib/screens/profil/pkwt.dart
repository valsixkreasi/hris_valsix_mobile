...
class Pkwt extends StatefulWidget {
  const Pkwt({super.key});

  @override
  State<Pkwt> createState() => _PkwtState();
}

class _PkwtState extends State<Pkwt> {
  ...
  void getData() {
    _getData().then((value) {
      ...
      if (value != null) {
        ...
        List<Map<String, dynamic>> arrData = List.from(profil['pkwt']);
