  ...
  void getData() {
    _getData().then((value) {
      ...
      if (value != null) {
        ...
        List<Map<String, dynamic>> arrData = List.from(profil['pengalaman']);
    ...
    return RefreshIndicator(
      ...
      child: NavHeader(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.pushNamed(context, '/pengalaman_add');
            },
                    ...
                    ? Column(
                        children: [
                          ...List.generate(data.length, (index) {
                            ...
                            return Button(
                              onPressed: () {
                                if (dataItem['pengajuan_pengalaman_id'] !=
                                    null) {
                                } else {
                                  // Navigator.pushNamed(
                                  //   context,
                                  //   '/pengalaman_view',
                                  //   arguments: {
                                  //     'id': dataItem['pengajuan_pengalaman_id'],
                                  //   },
                                  // );
                                }
                              },
                              ...
                              child: Card(
                                ...
                                color:
                                    dataItem['pengajuan_pengalaman_id'] != null
                                        ? Color(0xfffee86d)
                                        : Color(0xfff2f2f2),
                                child: Column(
                                  children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          InputView(
                                              label: 'Tanggal Masuk	 :',
                                              value:
                                                  dataItem['tanggal_masuk'] ??
                                                      '-'),
                                          InputView(
                                              label: 'Durasi :',
                                              value:
                                                  '${dataItem['durasi_tahun'] ?? '-'} tahun ${dataItem['durasi_bulan'] ?? '-'} bulan'),
                                          InputView(
                                              label: 'Dokumen :', value: '-'),
                                        ],
                                      ),
