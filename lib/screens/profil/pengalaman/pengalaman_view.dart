...
class PengalamanView extends StatefulWidget {
  final Object? arguments;
  const PengalamanView({super.key, this.arguments});

  @override
  State<PengalamanView> createState() => _PengalamanViewState();
}

class _PengalamanViewState extends State<PengalamanView> {
