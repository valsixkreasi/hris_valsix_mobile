...
class Hukuman extends StatefulWidget {
  const Hukuman({super.key});

  @override
  State<Hukuman> createState() => _HukumanState();
}

class _HukumanState extends State<Hukuman> {
  ...
  void getData() {
    _getData().then((value) {
      ...
      if (value != null) {
        ...
        List<Map<String, dynamic>> arrData = List.from(profil['hukuman']);
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        InputView(
                                            label: 'Jenis Sanksi :',
                                            value: dataItem['jenis_sanksi'] ??
                                                '-'),
                                        InputView(
                                            label: 'Tanggal Kejadian :',
                                            value:
                                                dataItem['tanggal_kejadian'] ??
                                                    '-'),
                                        InputView(
                                            label: 'Tanggal Surat :',
                                            value:
                                        ...
                                        InputView(
                                            label: 'Masa Hukuman :',
                                            value:
                                                '${dataItem['tanggal_pengembalian_awal'] ?? '-'} s/d ${dataItem['tanggal_pengembalian_akhir'] ?? '-'}'),
                                        InputView(
                                            label: 'Kewajiban Pengembalian :',
                                            value:
                                                '${dataItem['kerugian'] ?? '-'}'),
                                        InputView(
                                            label: 'Deskripsi :',
