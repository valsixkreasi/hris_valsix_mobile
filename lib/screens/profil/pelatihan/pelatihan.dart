...
class Pelatihan extends StatefulWidget {
  const Pelatihan({super.key});

  @override
  State<Pelatihan> createState() => _PelatihanState();
}
  ...
  void getData() {
    _getData().then((value) {
      ...
      if (value != null) {
        ...
        List<Map<String, dynamic>> arrData = List.from(profil['pelatihan']);
    ...
    return RefreshIndicator(
      ...
      child: NavHeader(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.pushNamed(context, '/pelatihan_add');
            },
                    ...
                    ? Column(
                        children: [
                          ...List.generate(data.length, (index) {
                            ...
                            return Button(
                              onPressed: () {
                                if (dataItem['pengajuan_pelatihan_id'] !=
                                    null) {
                                } else {
                                  // Navigator.pushNamed(
                                  //   context,
                                  //   '/pelatihan_view',
                                  //   arguments: {
                                  //     'id': dataItem['pengajuan_pelatihan_id'],
                                  //   },
                                  // );
                                }
                              },
                              ...
                              child: Card(
                                ...
                                color:
                                    dataItem['pengajuan_pelatihan_id'] != null
                                        ? Color(0xfffee86d)
                                        : Color(0xfff2f2f2),
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          InputView(
                                              label: 'Lokasi :',
                                              value: dataItem['lokasi'] ?? '-'),
                                          InputView(
                                              label: 'Penyelenggara :',
                                              value:
                                                  dataItem['penyelenggara'] ??
                                                      '-'),
                                          InputView(
                                              label: 'Jml. Jam :',
                                              value: dataItem['jumlah_jam'] ??
                                                  '-'),
                                          InputView(
                                              label: 'Sertifikat :',
                                              value: '-'),
