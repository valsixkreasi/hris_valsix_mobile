// ignore_for_file: implementation_imports, constant_identifier_names, prefer_function_declarations_over_variables, unused_element
...
import 'package:dropdown_search/src/modal_dialog.dart';
import 'package:dropdown_search/src/popupMenu.dart';
import 'package:dropdown_search/src/properties/popup_safearea_props.dart';
...
export 'package:dropdown_search/src/properties/popup_safearea_props.dart';
export 'package:dropdown_search/src/properties/scrollbar_props.dart';
export 'package:dropdown_search/src/properties/selection_list_view_props.dart';
export 'package:dropdown_search/src/properties/text_field_props.dart';
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  Widget _manageTrailingIcons() {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        if (widget.showDropdownButton == true)
  ...
  Widget _selectDialogInstance({double? defaultWidth, double? defaultHeight}) {
